...
int main() 
{
    ...
    vector<string> lista_cuvinte = {"proiectant", "programare", "rinocer", "carte", "romania", "ploaie", "strugure", "albina", "restaurant", "adunare", "mancare", "perpendicular", "paralelipiped", "creatie"};
